...
import SearchWidget from 'vxrd/components/HomeComponent/DesktopSearchWidget2'
import VXRSelect2 from 'vxrd/components/VXRSelect2'
import { LANG } from '#/utils/constants';

const { Option, OptionGroup } = VXRSelect2;
...
class SearchWidgetContainer extends PureComponent {
  ...
  render() {
    ...
    const {
      isDayBlocked, todayText, lunarText,
      placeholderFrom, placeholderTo, placeholderDate,
